...
class ProduitModel {
  ...
  ///
  /// Dans le modèle ISITEK, la colonne "Remise" est un pourcentage
  /// (ex: 15%) qui est appliqué sur le montant brut de la ligne
  /// (Quantité × PUHT) afin d'obtenir le montant HT Net.
  ...
  /// Construction d'un ProduitModel à partir d'une Map.
